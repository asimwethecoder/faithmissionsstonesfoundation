                ...
                <div
                  ...
                  <div className='tab-wrap'>
                    ...
                    <div className='right'>
                      <ul>
                        <li>
                          <i className='flaticon-check'></i> People’s Growth
                        </li>
                        <li>
                          <i className='flaticon-check'></i>Helped fund 3,265
                          Project powerful
                        </li>
                        <li>
                ...
                <div
                  ...
                  <div className='tab-wrap'>
                    ...
                    <div className='right'>
                      <ul>
                        <li>
                          <i className='flaticon-check'></i> The standard chunk
                          of Lorem Ipsum
                        </li>
                        <li>
                          <i className='flaticon-check'></i>Helped fund 3,265
                ...
                <div
                  ...
                  <div className='tab-wrap'>
                    ...
                    <div className='right'>
                      <ul>
                        <li>
                          <i className='flaticon-check'></i>There are many
