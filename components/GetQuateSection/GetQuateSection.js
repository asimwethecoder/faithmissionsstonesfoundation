        ...
        <div className='row align-items-center'>
          <div className='col-lg-6 col-12'>
            <div className='left-wrap'>
              <h2>
                {' '}
                <Image src={Healt} alt='' /> Non profit Charity Fundation
              </h2>
              <h3>
              ...
              <ul className='icontext'>
                <li>
                  <i className='flaticon-fund'></i>Fund Raised & Donation Treat
                  raised
                </li>
                <li>
                  <i className='flaticon-cardiogram'></i>We Helping People &
                  Donation pik
                </li>
              </ul>
              <ul className='op-item'>
                <li>
                  <i className='flaticon-check'></i>Dedicated Team & volunteer
                </li>
                <li>
                  <i className='flaticon-check'></i>Domestics & Logistics
                </li>
              </ul>
            </div>
          </div>
