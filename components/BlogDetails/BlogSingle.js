...
const BlogSingle = props => {
  ...
  return (
    <section
      className={`blog-single-section section-padding ${props.blSclass}`}>
          ...
          <div className={`col col-lg-8 col-12 ${props.blRight}`}>
            <div className='blog-content'>
              <div className='post format-standard-image'>
                ...
                <div className='entry-details'>
                  ...
                  <p>
                    ...
                    elit eu lacus. Vestibulum non justo fun consectetur, cursus
                    ante, tincidunt sapien. Nulla quis diam sit amet turpis
                    interd enim. Vivamus fauc ex sed nibh egestas elementum.
                    Mauris et bibendum
                  </p>
                </div>
              </div>
              ...
              <p>
                ...
                sit amet, consectetur adipiscing elit. vestibulum rhoncus, dolor
                eget viverra pretium, dolor ellus aliquet nunc,
              </p>
                          ...
                          <div className='comment-wrapper'>
                            ...
                            <div className='comment-area'>
                              <p>
                                ...
                                opularisedthe with the release of Letrasetsheets
                                containingth leap electrtypesetting
                                remainingmajority have. There are many
                              ...
                              <div className='comment-wrapper'>
                                ...
                                <div className='comment-area'>
                                  <p>
                                    ...
                                    have. There are many variations of passages
                                  </p>
                                </div>
                              </div>
                            </div>
